...
void bench_throughput() {
    ...
    std::println("  {} tasks, {} ms", TASKS, ms);
    std::println("  throughput: {:.0f} tasks/s", TASKS * 1000.0 / ms);
...
void bench_latency() {
    ...
    std::println("  mean latency: {} ns", avg);
    std::println("  P50 latency: {} ns", p50);
    std::println("  P99 latency: {} ns", p99);
}

void bench_contention() {
    std::println("\n=== contention test (multi-producer) ===");
    ...
    std::println("  {} producers x {} tasks = {} total tasks", PRODUCERS, TASKS_PER_PRODUCER, total);
    std::println("  time: {} ms", ms);
    std::println("  throughput: {:.0f} tasks/s", total * 1000.0 / ms);
