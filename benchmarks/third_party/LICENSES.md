...
| `concurrentqueue.h` | https://github.com/cameron314/concurrentqueue （master） | Simplified BSD — © 2013-2020 Cameron Desrochers | 无锁 MPMC 队列单头文件，自建池基线的队列核心 |

oneTBB 经系统包引入（`find_package(TBB)`），未随仓库分发。
